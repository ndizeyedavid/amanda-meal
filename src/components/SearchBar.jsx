...
export default function SearchBar({ setSearch, search }) {
    ...
    return (
        <form onSubmit={handleSubmit(searching)} className="flex items-center px-3 w-[95%] mx-auto h-[50px]  rounded-md shadow-[0px_2px_9px_0px_rgba(0,0,0,0.4)]">
            ...
            <div className="w-full h-full">
                <input type="search" name="search" id="search" placeholder="Search any product..." defaultValue={search} className="w-full h-full px-3 bg-transparent outline-none" {...register("search_txt")} />
            </div>
